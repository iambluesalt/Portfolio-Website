...
export default function ContactComponent() {
    return (
    <div className="relative flex items-start gap-4 sm:gap-6 rounded-xl border border-zinc-200/70 dark:border-zinc-800/70 bg-white/70 dark:bg-zinc-900/60 p-5 sm:p-6 md:p-8 shadow-sm ring-1 ring-black/5 dark:ring-white/5">
