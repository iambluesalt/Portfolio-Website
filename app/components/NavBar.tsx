      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex h-14 sm:h-14 md:h-16 items-center justify-between rounded-xl bg-white dark:bg-zinc-900 shadow-md px-3 sm:px-4 md:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="/Aaditya-Pandagle-Resume.pdf" download className="inline-flex md:inline-flex items-center gap-1 text-[12px] font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 md:mr-0 mr-2">
