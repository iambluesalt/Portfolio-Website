    ...
    <div className={`relative my-20 first:mt-0 ${className}`}>
      ...
      {label && (
        <div className="relative flex justify-center">
          <span className="group inline-flex items-center gap-1 rounded-full border border-zinc-400/70 dark:border-zinc-700/70 bg-white/80 dark:bg-zinc-900/70 backdrop-blur md:px-5 px-4 py-1 md:py-1.5 text-[14px] font-medium tracking-wide text-zinc-600 dark:text-zinc-300 shadow-sm">
            {label}
